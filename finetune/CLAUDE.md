...
- `../GPUModel/pkm-ft-1.7b-v3`（純 YT1、刻意過擬合）；`../GPUModel/pkm-ft-1.7b-v4`（修 撒嬌/戲法空間/仙子伊布 三詞誤判：重組 split 把 yt5 `h51` 移入訓練＋過取樣 ×8；hold-out 戲法 3→9、仙子 0→5）；`../GPUModel/pkm-ft-1.7b-v5`（2026-07-02：golden 手校驅動補訓 裸催/急凍鳥/極光幕/選手名等零曝光專名，端到端裸催 0→55/53；詳見 [`v4全片診斷_v5執行.md`](v4全片診斷_v5執行.md)）。**皆非預設**，app 下拉可選。
